...
債権者情報欄の「CSVダウンロード」から、登録済み債権者の一覧（債権者名・郵便番号・住所・電話・FAX・債権額・備考）をCSVでダウンロードできます。裁判所の債権者一覧書式にそのまま貼り付けられます。「宛名ラベル」からは、債権者全員分の宛名ラベル（A4・12面）をWordファイルで出力できます。どちらも詳細画面と同じフリガナ順で出力され、13件以上でもラベルは自動でページが続きます。
