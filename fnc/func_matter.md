...
これらの情報を事件ファイルに一元化できればと思ったことはありませんか。 firmeeは弁護士のそんな願いをかなえるソフトです。 <br>

## ３つの特徴

**1 あらゆる情報を一元管理できます**

裁判所に関する情報はもちろん、実費の処理に期日情報、関与する弁護士の情報から電話メモまで。様々な情報を事件ファイルで一元管理できます。 <br>
...
また随時書式を追加しております。ご希望の書式があればお気軽にご意見をお寄せください。 <br>
...
そのほか、依頼者と担当弁護士が同じ新件を受任した際に重宝する「ファイルコピー」など、かゆいところに手が届く様々な機能を用意しています。ファイルコピーでは、コピー元の[関与弁護士](func-related-lawyers.md)（担当弁護士を含む）も引き継がれるので、共有し直す手間がかかりません。是非一度お試し下さい。\
...
必須項目は、事件名と依頼者名だけ。\
また、いずれの項目も後に編集・変更が可能なので、気軽に事件ファイルを作成しましょう。 <br>
...
*   **刑事訴訟**
    ...
    ：被疑者・被告人はもちろん、被害者参加に関する事件ファイルも作れます。勾留場所（拘置所・警察署・刑務所）や部署の電話・FAX、備考も事件に紐づけて管理できます。
*   **家事訴訟**
...
*   **債務整理**
    ...
    ：債務整理案件に特化したファイルです。債権者情報・債権額の管理や受任通知の送付状況を一元管理できます。詳しくは[債務整理タイプの事件管理](func-saimuseiri.md)をご覧ください。
...
*   **勾留場所（刑事訴訟）**
    ...
    ：刑事事件では、勾留場所として拘置所・警察署・刑務所などの公務所を検索して登録できます（全国データ登録済み）。部署を選ぶと、登録済みの電話・FAXが事件詳細に表示されます。保釈や勾留執行停止などの状態は、勾留の備考欄に記載できます。事件詳細では「事件・事故」の次に表示されます。
...
* **備考** ：事件に関するあらゆる情報をフリーワードで保存できます。入力内容を横断検索できますので、関連判例や論文など、あらゆる情報を備忘として登録できます。 \
  ![](<../.gitbook/assets/スクリーンショット 2022-06-28 17.40.34.png>)<br>
